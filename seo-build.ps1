...
Write-Host "3. Test the sitemap at https://www.majamoger.com/sitemap.xml"
...
Write-Host "- https://www.majamoger.com/sitemap.xml"
Write-Host "- https://www.majamoger.com/robots.txt"
